...
//    auto d = sat_domain<25, 8, 3, 111, false>();
    // Tato domena pak ma:
    ...
    // muzete takto:
       auto d = sp_domain<3, 70, 0>();
    // Inicialni pozice je gsat = sat_domain<25, 8, 3, 111, false>()enerovana provedenim 70 nahodnych tahu (nahodny
